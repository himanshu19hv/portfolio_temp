      ...
      <div className="container">
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOut="fadeInUp" animateOnce>
          <p className={styles.concepts__description}>
            After we were done with our high-level user observations and pain
            points, we began our ideate, prototype and refine. From User flows
            to UI concepts, we explored a spectrum of possibilities. By the end
            of the week, we distilled our efforts into a handful of promising
            concepts - those that were feasible, useable and impactful.
          </p>
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInUp" animateOut="fadeInUp" animateOnce>
        ...
        <div className={styles.concepts__grid}>
          ...
          >
            <div className={styles.concepts__item}>
              ...
              <p className={styles.concepts__caption}>
                Understanding of what are the constraints with the partner banks
                with their respective API flows
              </p>
            </div>
          </ScrollAnimation>
          <ScrollAnimation
          ...
          >
            <div className={styles.concepts__item}>
              ...
              <span>step 2</span>
              <p className={styles.concepts__caption}>
                High level journey with the execution details and what would be
                expected with respective banks and the constraints.
              </p>
            </div>
          </ScrollAnimation>
          <ScrollAnimation
          ...
          >
            <div className={styles.concepts__item}>
              ...
              <span>step 3</span>
              <p className={styles.concepts__caption}>
                Once the high level journey was done, it was refined to ensure
                how the user flow looks like first goes up is clear idea of the
                operating good cases.
              </p>
            </div>
          </ScrollAnimation>
          <div className={styles.concepts__sketches}>
            ...
            >
              <div className={styles.concepts__sketch}>
                ...
                <p className={styles.concepts__sketchCaption}>
                  Once the user flow was cemented the next steps were to diverge
                  and see if the journey would break anywhere along with the
                  understanding of which flows would amount to a less TTV(Time
                  to Value).
                </p>
              </div>
            </ScrollAnimation>
            ...
            >
              <div className={styles.concepts__sketch}>
                ...
                <p className={styles.concepts__sketchCaption}>
                  Post Lo-Fi testing tweaked the flow a bit and checked if the
                  updated screens impacted the TTV along with no of clicks it
                  would take for a user to complete the task.
                </p>
              </div>
            </ScrollAnimation>
          </div>
