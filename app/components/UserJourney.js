        ...
        <div className="container">
          ...
          <div className={styles.features2__text2}>
            <p>
              ...
              initial contribution margin (CM2) of the B2C channel increased by
              14% MOM for the last Quarters.
            </p>
            <p>
              With the ability to provide a seamless experience in the
              remittance market we gained huge traction in the new user sign ups
              increased by a massive 43%.
            </p>
            <p>
              With B2C experience in place we were able to establish ourself in
              the big world of Fintechs and were already a name in the
